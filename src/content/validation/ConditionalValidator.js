...
// Clean up any remaining invalid keys
const CLEAN_CATEGORY_VALIDATION_LEVEL = {
    ...CATEGORY_VALIDATION_LEVEL,
    'substance-abuse': undefined,
    'addiction': undefined,
    'extreme-sounds': undefined
};
/**
...
export class ConditionalValidator {
    ...
    validate(detection, relatedDetections) {
        ...
        // @ts-ignore
        const validationLevel = CATEGORY_VALIDATION_LEVEL[detection.category] || 'standard';
